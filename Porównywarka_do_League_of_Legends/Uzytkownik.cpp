...
void Postac_uzytkownika::wybierzPostac()
{
	cout<<"Podaj nazwe(nick) swojej postaci w grze League of Legends: ";	cin>>nazwapostaci;	cout<<endl;
	cout<<"Wybierz klase swojej postaci wpisujac odpowiadajaca jej liczbe:"<<endl<<endl;
	do
	{
		cout<<"1) Kayle"<<endl;
		cout<<"2) Rek'sai"<<endl;
		...
		if(wybierz==1) {typ="Kayle";	cout<<"Twoja postac to "<<typ<<endl;}
		if(wybierz==2) {typ="Rek'sai";	cout<<"Twoja postac to "<<typ<<endl;}
		if(wybierz==3) {typ="Tristana";	cout<<"Twoja postac to "<<typ<<endl;}
		if(wybierz==4) {typ="Trundle";	cout<<"Twoja postac to "<<typ<<endl;}
		if(wybierz==5) {typ="Zac";		cout<<"Twoja postac to "<<typ<<endl;}
		if(wybierz<1 || wybierz>5) cout<<"Niestety nie ma takiej postaci w bazie, wybierz jeszcze raz."<<endl;
	}while(wybierz<1 || wybierz>5);

	do
	{
		cout<<"Podaj aktualny poziom swojej postaci od 1 do 18: "; cin>>poziompostaci; cout<<endl; 
...
double Postac_uzytkownika::algorytmObliczeniaProcentu(int p)
{
...
double Postac_uzytkownika::opoznienieAtaku(double predkosc,int poziom, double procent)
{
	srand(time(NULL));
	int a,b;
...
void Postac_uzytkownika::wyswietlStatyPostaci()
{
...
void Postac_uzytkownika::wyswietlEkwipunek()
{
...
void Postac_uzytkownika::poczatkoweStaty(int w,int p)
{
...
void Postac_uzytkownika::ekwipunekPostaci(string postac)
{
	int licznik=3;
